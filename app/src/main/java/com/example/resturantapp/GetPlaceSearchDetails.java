...
public class GetPlaceSearchDetails extends AsyncTask<Object,String,String>  {
        ...
        public GetPlaceSearchDetails(Context context,RecyclerView recyclerView){
...
//     }
                ...
                popularPlaceRecyclerViewAdapter=new popularPlaceRecyclerViewAdapter(context,photoUrls,placeName,vicinity,
                        rating,placeId,longitudeAndLatitude,photo_reference);
